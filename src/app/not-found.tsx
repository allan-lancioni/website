  ...
  return (
    <section className="flex flex-col items-center justify-center h-screen-minus-32 p-12 text-center bg-gradient-to-br from-gray-800 to-gray-900">
      <div className="relative z-10">
        <h1 className="font-serif text-4xl md:text-6xl text-white mb-4">404</h1>
        ...
        <Link
          href="/"
          className="font-sans font-semibold text-white bg-blue-500 py-3 px-6 rounded-full transition duration-300 hover:bg-blue-700"
        >
          Voltar ao Início
        </Link>
      </div>
